        ...
        >
          ...
          <div class="p-6 md:p-8 text-center">
            ...
            <div class="relative mb-5 flex items-center justify-center">
              ...
              >
                <!-- Success Check -->
                <svg v-if="variant === 'success'" class="w-8 h-8 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7" />
                </svg>
                <!-- Error X -->
                <svg v-else-if="variant === 'error'" class="w-8 h-8 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M6 18L18 6M6 6l12 12" />
                </svg>
                <!-- Warning Triangle -->
                <svg v-else-if="variant === 'warning'" class="w-8 h-8 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
